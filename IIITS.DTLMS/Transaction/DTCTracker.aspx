        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span8">
                    ...
                    <h3 class="page-title">DTC Tracker
                    </h3>
                ...
                <div class="span12">
                    ...
                    <div class="widget blue">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>DTC Tracker
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                        <asp:TextBox ID="txtDTCCode" runat="server" MaxLength="9" autocomplete="off"></asp:TextBox>
                                                        <asp:Button ID="btnSearchId" Text="S" class="btn btn-primary" runat="server" /><br />
                                                        <asp:LinkButton ID="lnkDTCDetails" runat="server"
                                                            Style="font-size: 12px; color: Blue" OnClick="lnkDTCDetails_Click" OnClientClick="javascript:return ValidateMyForm()">View DTC Details</asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="control-group">
                        ...
                        <div class="widget-body">
                            <div class="widget-body form">
                                ...
                                <div class="form-horizontal">
                                   ...
                                   <asp:Label ID="lblDTCLoad" runat="server" Text="Connected Load (KW)"></asp:Label>
                                            &nbsp&nbsp&nbsp&nbsp 
                                   <asp:TextBox ID="txtLoad" runat="server" ReadOnly="true"></asp:TextBox>
                                            &nbsp&nbsp&nbsp&nbsp 
                                        ...
                                        <asp:GridView ID="grdDTcDetails" AutoGenerateColumns="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField AccessibleHeaderText="DATE" HeaderText="Date">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblDate" runat="server" Text='<%# Bind("TRANSDATE") %>' Style="word-break: break-all" Width="150px"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField AccessibleHeaderText="STATUS" HeaderText="Status" SortExpression="STATUS">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblStatus" runat="server" Text='<%# Bind("STATUS") %>' Style="word-break: break-all" Width="450px"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField AccessibleHeaderText="DCT_DTR_CODE" HeaderText="DTR Code" SortExpression="DCT_DTR_CODE">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblDTrCode" runat="server" Text='<%# Bind("DCT_DTR_CODE") %>' Style="word-break: break-all" Width="450px"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="color: Black">
                        <i class="fa fa-info-circle"></i>This Web Page Can Be Used To Track DTC
                    </p>
                    <p style="color: Black">
                        <i class="fa fa-info-circle"></i>User Can Enter Or Search Dtr Code in DTC Code TextBox
                    </p>
                    <p style="color: Black">
                        <i class="fa fa-info-circle"></i>After Entering DTC Code Click On Load Button To
                        Get The Details
                    </p>
                </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/DTLMS.Master" AutoEventWireup="true" CodeBehind="PMCDeliveryInst.aspx.cs" 
    Inherits="IIITS.DTLMS.POFlow.PMCDeliveryInst" %>
                                ...
                                <div class="form-horizontal">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                        ...
                                                        <asp:TextBox ID="txtPODate" runat="server" Visible="false"></asp:TextBox>
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">
                                                    DWA No <span class="Mandotary">*</span>
                                                </label>
                                                <div class="controls">
                                                    <div class="input-append">
                                                        <div class="input-append">
                                                            <asp:TextBox ID="txtDWANo" ReadOnly="true" runat="server"></asp:TextBox>
                                                            <asp:TextBox ID="txtDWAExp" runat="server" Visible="false"></asp:TextBox>
                                        ...
                                        <div class="span6">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">
                                                    LEC Name <span class="Mandotary">*</span>
                                                </label>
                                                <div class="input-append">
                                                    <div class="input-append">
                                                        <asp:TextBox ID="txtLECName" ReadOnly="true" runat="server"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="span6">
                                            <asp:GridView ID="grdPendingTC" AutoGenerateColumns="false" PageSize="5"
                                                ...
                                                OnPageIndexChanging="grdPendingTC_PageIndexChanging"
                                                AllowPaging="true"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField AccessibleHeaderText="PMC_PO_NO" HeaderText="Po number">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblPOId" runat="server" Text='<%# Bind("sPMC_PO_NO") %>'>

                                                            </asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField AccessibleHeaderText="PMC_PB_MAKE" HeaderText="Make" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblMakeId" runat="server" Text='<%# Bind("sPMC_PB_MAKE") %>'>
                                                    ...
                                                    <asp:TemplateField AccessibleHeaderText="PMC_PO_RATING" HeaderText="Rating" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblRatingId" runat="server" Text='<%# Bind("sPMC_PO_RATING") %>'>
                                        ...
                                        <div class="span6">
                                            ...
                                            <asp:GridView ID="gvFiles" runat="server" AutoGenerateColumns="false" PageSize="5" 
                                                ShowHeaderWhenEmpty="true"
                                                EmptyDataText="No records Found"
                                                ShowFooter="false" CssClass="table table-striped table-bordered table-advance table-hover" 
                                                AllowPaging="true"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Name" ItemStyle-ForeColor="BlueViolet" 
                                                        HeaderText="Download PO Documents" 
                                                        ItemStyle-Width="350" />
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                   ...
                                                   <asp:LinkButton ID="lnkDownload1" runat="server" ForeColor="Blue" 
                                                       Text="<i class='icon-download-alt'></i> DOWNLOAD"
                                ...
                                <div class="widget-body form">
                                    ...
                                    <div class="form-horizontal">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-append">
                                                            ...
                                                            <asp:TextBox ID="txtDINumber" runat="server" MaxLength="20"
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-append">
                                                            ...
                                                            <ajax:CalendarExtender ID="DeliveryCalendar" runat="server" CssClass="cal_Theme1" 
                                                                Format="dd/MM/yyyy"
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-append">
                                                            <asp:DropDownList ID="cmbMake" runat="server" AutoPostBack="true"
                                                                OnSelectedIndexChanged="cmbMake_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-append">
                                                            ...
                                                            <ajax:CalendarExtender ID="ManufactureCalender" runat="server" CssClass="cal_Theme1" 
                                                                Format="dd/MM/yyyy"
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-append">
                                                            <asp:TextBox ID="txtQuantity" runat="server" MaxLength="8" 
                                                                onkeypress="javascript:return AllowNumberAndSecialChe(this,event);" ></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                        ...
                                        <asp:GridView ID="grdDelivery" AutoGenerateColumns="false" PageSize="10"
                                            ...
                                            runat="server" TabIndex="16" OnPageIndexChanging="grdDelivery_PageIndexChanging" 
                                            OnRowCommand="grdDelivery_RowCommand">
                                            <Columns>
                                                <asp:TemplateField HeaderText="Sl No" HeaderStyle-Width="5%" HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <%#Container.DataItemIndex+1 %>
                                                ...
                                                <asp:TemplateField AccessibleHeaderText="DI_CAPACITY" HeaderText="Capacity" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCapacityID" runat="server" Text='<%# Bind("DI_CAPACITY_ID") %>'>
                                                ...
                                                <asp:TemplateField AccessibleHeaderText="DI_START_RANGE" HeaderText="Start Range" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblstartRange" runat="server" Text='<%# Bind("DI_START_RANGE") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField AccessibleHeaderText="DI_END_RANGE" HeaderText="End Range" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblendRange" runat="server" Text='<%# Bind("DI_END_RANGE") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                 <asp:TemplateField AccessibleHeaderText="PMC_DI_TC_START_RANGE_VAR" HeaderText="Start Range">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblstartRange1" runat="server" Text='<%# Bind("PMC_DI_TC_START_RANGE_VAR") %>'>

                                                        </asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField AccessibleHeaderText="PMC_DI_TC_END_RANGE_VAR" HeaderText="End Range">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblendRange1" runat="server" Text='<%# Bind("PMC_DI_TC_END_RANGE_VAR") %>'>
                                                ...
                                                <asp:TemplateField HeaderText="Edit">
                                                    <ItemTemplate>
                                                        <center>
                                                            <asp:ImageButton ID="imgBtnEdit" Title=" Click To Edit" runat="server" 
                                                                Height="12px" ImageUrl="~/Styles/images/edit64x64.png"
                                                ...
                                                <asp:TemplateField HeaderText="Delete">
                                                    <ItemTemplate>
                                                        <center>
                                                            <asp:ImageButton ID="imgBtnDelete" Title="Click To Delete" runat="server" 
                                                                Height="12px" ImageUrl="~/Styles/images/delete64x64.png"
                                        ...
                                        <asp:GridView ID="grdDIdocs" runat="server" AutoGenerateColumns="false" PageSize="5" 
                                            ShowHeaderWhenEmpty="true"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Name" ItemStyle-ForeColor="BlueViolet" 
                                                    HeaderText="Download Delivey Documents" ItemStyle-Width="700" />
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkDownload" runat="server" ForeColor="Blue" 
                                                            Text="<i class='icon-eye-open'></i> VIEW"
                                    ...
                                    <div class="text-center">
                                        ...
                                        <asp:Button ID="btnReset" runat="server" Text="Reset"
                                            CssClass="btn btn-danger" OnClick="btnReset_Click1" />

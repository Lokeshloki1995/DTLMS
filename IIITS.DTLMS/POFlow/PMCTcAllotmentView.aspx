<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/DTLMS.Master" CodeBehind="PMCTcAllotmentView.aspx.cs" 
    Inherits="IIITS.DTLMS.MasterForms.PMCTcAllotmentView" %>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget blue" >
                        <div class="widget-title" >
                            <h4><i class="icon-reorder"></i>DTr Allotment View</h4>
                            <span class="tools">
                              ...
                              <%--          <div class="span6">--%>
                                   ...
                                   <%--         <%#Container.DataItemIndex+1 %>--%>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="DIM_DI_NO" HeaderText="Dispatch No">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDINO" width="100" runat="server" Text='<%# Bind("PMC_DIM_DI_NO") %>'></asp:Label>
                                            </ItemTemplate>
                                            ...
                                            <ItemTemplate>
                                               ...
                                               <ItemTemplate>
                                                   <asp:LinkButton ID="lnkload" runat="server" ForeColor="Blue" Width="100"  Text="View"  
                                                        OnClick="cmdLoad_click"   CommandArgument='<%# Eval("PMC_DIM_DI_NO") %>'> </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                                    </asp:GridView>
               ...
               <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget blue" >
                        <div class="widget-title">
                            <h4 id="CreateDI"  runat="server"><i class="icon-reorder"></i>DTr Allotment View Details</h4>
                            <span class="tools">
                                <a href="javascript:;" class="icon-chevron-down"></a>
                            </span>
                        </div>
                             ...
                             <HeaderStyle CssClass="both"/>
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sl No" HeaderStyle-Width="5%" HeaderStyle-HorizontalAlign="Left">
                                        ...
                                        <ItemTemplate>                                       
                                            <asp:Label ID="lblAltid" runat="server" Text='<%# Bind("PDRA_ID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField AccessibleHeaderText="PO_NO" HeaderText="PO NO" >                                
                                        <ItemTemplate>                                       
                                            <asp:Label ID="lblDIPoNo" runat="server" Text='<%# Bind("PMC_PO_NO") %>'></asp:Label>
                                        </ItemTemplate>
                                     ...
                                     <asp:TemplateField AccessibleHeaderText="TCP_TC_CODE" HeaderText="DTr Code">                                
                                        <ItemTemplate>                                       
                                            <asp:Label ID="lblDTr" runat="server" Text='<%# Bind("PDRA_TC_CODE") %>' 
                                                style="word-break:break-all" Width="80px"></asp:Label>                                 
                                        </ItemTemplate>

                                         <FooterTemplate>
                                         <asp:Panel ID="panel3" runat="server" DefaultButton="btnSearch" >
                                             <asp:TextBox ID="txtaltNumber" runat="server"  Width="120px" 
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="DI_CAPACITY" HeaderText="Capacity">                                      
                                        <ItemTemplate>
                                            <asp:Label ID="lblCapacity" runat="server" Text='<%# Bind("PMC_DI_CAPACITY") %>' 
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="TCP_TC_SL_NO" HeaderText="DTr Sl No">                                      
                                        <ItemTemplate>
                                            <asp:Label ID="lblSlNo" runat="server" Text='<%# Bind("PDRA_TC_SL_NO") %>' 
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="TCP_MANUFACTURE_DATE" HeaderText="Manufacture Date">                                      
                                        <ItemTemplate>
                                            <asp:Label ID="lblManfDate" runat="server" Text='<%# Bind("PDRA_MANUFACTURE_DATE") %>' 
                                                style="word-break:break-all" Width="70px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField AccessibleHeaderText="TCP_TC_LIFE_SPAN" HeaderText="Life Span">                                      
                                        <ItemTemplate>
                                            <asp:Label ID="lblLifeSpan" runat="server" Text='<%# Bind("PDRA_TC_LIFE_SPAN") %>' 
                                                style="word-break:break-all" Width="70px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField AccessibleHeaderText="TCP_TC_WARRENTY_PERIOD" HeaderText="Warrenty Period">                                      
                                        <ItemTemplate>
                                            <asp:Label ID="lblWarrentyPeriod" runat="server" Text='<%# Bind("PDRA_TC_WARRENTY_PERIOD") %>' 
                                                style="word-break:break-all" Width="70px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField AccessibleHeaderText="TCP_OIL_TYPE" HeaderText="Oil Type">                                      
                                        <ItemTemplate>
                                            <asp:Label ID="lblOilType" runat="server" Text='<%# Bind("PDRA_OIL_TYPE") %>' 
                                                style="word-break:break-all" Width="150px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField AccessibleHeaderText="TCP_OIL_CAPACITY" HeaderText="DTr Oil Capacity">                                      
                                        <ItemTemplate>
                                            <asp:Label ID="lblOilCapacity" runat="server" Text='<%# Bind("PDRA_OIL_CAPACITY") %>' 
                                                style="word-break:break-all" Width="100px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField AccessibleHeaderText="TCP_OIL_WEIGHT" HeaderText="DTr Weight">                                      
                                        <ItemTemplate>
                                            <asp:Label ID="lblTcWeight" runat="server" Text='<%# Bind("PDRA_OIL_WEIGHT") %>' 
                                                style="word-break:break-all" Width="70px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                          <asp:TemplateField AccessibleHeaderText="PDRA_DTR_AMOUNT" HeaderText="DTr Amount">                                      
                                        <ItemTemplate>
                                            <asp:Label ID="lbldtramount" runat="server" Text='<%# Bind("PDRA_DTR_AMOUNT") %>' 
                                                style="word-break:break-all" Width="70px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="color: Black">
                        <i class="fa fa-info-circle"></i>This Web Page Can Be Used To View All DTr Allocation Details 
                        from store,Existing  Allocation Details Can be Edited and New DTr Allocation can Be Added.
                        </p>
                         <p style="color: Black">
                        <i class="fa fa-info-circle"></i>To View The DTr Allotment Details  Click On View Button To Get The Details
                        </p>
                        <p style="color: Black">
                        <i class="fa fa-info-circle"></i>To Add New DTr Allotment Click On  New Button
                        </p>

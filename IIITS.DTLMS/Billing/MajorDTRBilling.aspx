<%@ Page Title="" Language="C#" MasterPageFile="~/DTLMS.Master" AutoEventWireup="true" CodeBehind="MajorDTRBilling.aspx.cs" Inherits="IIITS.DTLMS.Billing.MajorDTRBilling" %>
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span8">
                    ...
                    <h3 class="page-title">Major DTR Billing
                    </h3>
                ...
                <div style="float: right; margin-top: 20px; margin-right: 12px">
                    <asp:Button ID="cmdClose" runat="server" Text="Bill View"
                        CssClass="btn btn-primary" OnClientClick="javascript:window.location.href='MajorBillingView.aspx'; return false;" />
                </div>
            </div>
            <!-- END PAGE HEADER-->
            <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="span12">
                    ...
                    <div class="widget blue">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Major DTR Billing</h4>
                            <span class="tools">
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="span5">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                        <asp:TextBox ID="txtEstAmount" runat="server"  ReadOnly="true"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <asp:GridView ID="grdMaterialMast" AutoGenerateColumns="false" PageSize="10" AllowPaging="false"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Actual Quantity">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtMqty" runat="server" Width="100px" MaxLength="7" Text='<%# Bind("RESTM_ITEM_QNTY") %>' onkeypress="javascript:return AllowNumber(this,event);"></asp:TextBox>
                                                                        </center>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                        ...
                                                        <asp:GridView ID="grdLabourMast" AutoGenerateColumns="false" PageSize="10" AllowPaging="false"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Actual Quantity">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtLqty" runat="server" Width="100px" MaxLength="7" Text='<%# Bind("RESTM_ITEM_QNTY") %>' onkeypress="javascript:return AllowNumber(this,event);"></asp:TextBox>
                                                                        </center>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                        ...
                                                        <asp:GridView ID="grdSalvageMast" AutoGenerateColumns="false" PageSize="10" AllowPaging="false"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Actual Quantity">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtSqty" runat="server" Width="100px" MaxLength="7" Text='<%# Bind("RESTM_ITEM_QNTY") %>' onkeypress="javascript:return AllowNumber(this,event);"></asp:TextBox>
                                                                        </center>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                ...
                                <div class="form-horizontal">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span5">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">BR No</label>
                                                <div class="controls">
                                                    <div class="input-append">
                                        ...
                                        <div class="span5">
                                            <div class="control-group">
                                             ...
                                             <div class="control-group">
                                                <label class="control-label">Expenditure booked </label>
                                                <div class="controls">
                                                    <div class="input-append">

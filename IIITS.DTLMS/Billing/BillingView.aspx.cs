...
{
    public partial class BillingView : System.Web.UI.Page
    {
        string strFormCode = "BillingView";
        ...
        protected void cmdNew_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("DTRBilling.aspx", false);
            }
            catch (Exception ex)
            {
                lblMessage.Text = clsException.ErrorMsg();
        ...
        protected void grdBilling_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "search")
                {
                    ...
                    if (txtWo.Text != "")
                    {
                        sFilter = "WO_NO Like '%" + txtWo.Text.Replace("'", "'") + "%' AND";
                    }
                    ...
                    if (txtInvNo.Text != "")
                    {
                        sFilter = "MB_INV_NO  Like '%" + txtInvNo.Text.Replace("'", "'") + "%' AND";
                    }

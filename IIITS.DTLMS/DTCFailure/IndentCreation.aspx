...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ValidateMyForm() {
            ...
            if (AvailQuantity == "0"||AvailQuantity==""||AvailQuantity==null) {
                var result = confirm('Requested ' + TcCapacity + ' Capacity DTr currently not available in the Store/Bank, Are you sure, Do you want to Continue?');
                if (result) {
                    return true;
                }
                else {
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <div class="span5">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-append">
                                                            <asp:DropDownList ID="cmbStoreName" runat="server" Enabled="true" TabIndex="4" AutoPostBack="true" OnSelectedIndexChanged="cmbStoreType_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="form-horizontal" align="center">
                                    ...
                                    <div class="span3">
                                        <asp:CheckBox ID="chkAlert" runat="server" Text=""
                                            CssClass="checkbox" Checked="true" TabIndex="6" visible="false" />
                                    </div>
                                    <div class="space20">
                                    </div>
                                    <div class="span6">

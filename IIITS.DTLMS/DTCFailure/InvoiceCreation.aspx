                                                    ...
                                                    <div class="controls">
                                                        <div class="input-append">
                                                            <asp:TextBox ID="txtDrawingDescription" MaxLength="500" TextMode="MultiLine" onkeyup="return ValidateTextlimit(this,500);"
                                                                Style="resize: none; width: 850px;" runat="server" TabIndex="10"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="form-horizontal">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span5">
                                            <div class="control-group">
                                                <label class="control-label">
                                                    Vehicle No<span class="Mandotary"> *</span></label>
                                                <div class="span1">
                                            ...
                                            <label class="control-label">
                                                Receipient Name<span class="Mandotary"> *</span></label>
                                            <div class="span1">
                                                <%--<span class="Mandotary">*</span>--%>
                                            </div>
                                            <div class="controls">
                                        ...
                                        <label class="control-label">
                                            Challen Number<span class="Mandotary"> *</span></label>
                                        <div class="span1">
                                           <%-- <span class="Mandotary">*</span>--%>
                                        </div>
                                        <div class="controls">

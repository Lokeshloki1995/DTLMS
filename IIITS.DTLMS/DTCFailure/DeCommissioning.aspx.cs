                ...
                else
                {
                    ...
                    if (!IsPostBack)
                    {
                        ...
                        if (objSession.sRoleType == "2")
                        {
                            ...
                            {
                                Genaral.Load_Combo("SELECT \"SM_ID\",\"SM_NAME\" FROM \"TBLSTOREMAST\" WHERE \"SM_STATUS\" ='A' AND \"SM_ID\"=" + objSession.OfficeCode + " or \"SM_ID\"=(SELECT \"STO_SM_ID\" from \"TBLSTOREOFFCODE\" WHERE \"STO_OLD_SMCODE\"='" + objSession.OfficeCode + "')", "-Select-", cmbStore);
                            }
                            else
                            {

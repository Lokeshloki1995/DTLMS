<%@ Page Title="" Language="C#" MasterPageFile="~/DTLMS.Master" AutoEventWireup="true" CodeBehind="CommissionDateMissMatch.aspx.cs"
    Inherits="IIITS.DTLMS.Query.CommissionDateMissMatch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ValidateMyForm() {
            ...
            if (document.getElementById('<%= txtDTrCommDate.ClientID %>').value.trim() == "") {
                alert('Select the DTR Commission Date')
                ...
                if (!FromdateInput.match(goodDate)) {
                    alert("Please Enter Valid DTR Commission Date Format");
                    return false;
                }
            }
            ...
            if (document.getElementById('<%=cmdUpdate.ClientID %>').value.trim() == "Update") {
                return confirm("Are You Sure, You Want To Update DTr Commission Date");
            }
        }
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span8">
                    ...
                    <h3 class="page-title">Commission Date Change
                    </h3>
                    <div class="span1">
                ...
                <div class="span12">
                    ...
                    <div class="widget blue">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Commission Date Change</h4>
                            <span class="tools">
            ...
            <div id="grdTable" style="display: none" runat="server">
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <div class="widget blue ">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i>Commission Date Change Details</h4>
                                <span class="tools">
                                    <a href="javascript:;" class="icon-chevron-down"></a>
                                    <a href="javascript:;" class="icon-remove"></a>
                                </span>
                                        ...
                                        <asp:GridView ID="grdDtrCommDateDetails" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                <asp:TemplateField AccessibleHeaderText="DTC_CODE" HeaderText="DTC Code" Visible="true"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblDtcCode" runat="server" Text='<%# Bind("DT_CODE") %>'
                                                ...
                                                <asp:TemplateField AccessibleHeaderText="TM_MAPPING_DATE" HeaderText="TM_MAPPING_DATE"
                                                    Visible="true" HeaderStyle-ForeColor="Black">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblDtrCommdate1" runat="server" Text='<%# Bind("TM_MAPPING_DATE") %>'
                                                            Style="word-break: break-all;"
                                                            Width="100px" ForeColor="Black" Enable="false"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField AccessibleHeaderText="DF_DATE" HeaderText="DF_DATE"
                                                    Visible="true" HeaderStyle-ForeColor="Black">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblDtrCommdate2" runat="server" Text='<%# Bind("DF_DATE") %>'
                                                            Style="word-break: break-all;"
                                                            Width="100px" ForeColor="Black"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField AccessibleHeaderText="DF_DTR_COMMISSION_DATE" HeaderText="DF_DTR_COMMISSION_DATE"
                                                    Visible="true" HeaderStyle-ForeColor="Black">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblDtrCommdate2" runat="server" Text='<%# Bind("DF_DTR_COMMISSION_DATE") %>'
                                                            Style="word-break: break-all;"
                                                            Width="100px" ForeColor="Black"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

<%@ Page Title="" Language="C#" MasterPageFile="~/DTLMS.Master" AutoEventWireup="true" CodeBehind="PermanentIndentView.aspx.cs" Inherits="IIITS.DTLMS.PermanentDecomm.PermanentIndentView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="span12">
                    ...
                    <div class="widget blue" >
                        <div class="widget-title" >
                            <h4><i class="icon-reorder"></i>Permanent Indent View</h4>
                            <span class="tools">
    ...
    <asp:TemplateField HeaderText="SL NO" HeaderStyle-Width="5%" HeaderStyle-HorizontalAlign="Left">
            ...
            <asp:TemplateField AccessibleHeaderText="TI_ID" HeaderText="Indent Id" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblIndentId" runat="server" Text='<%# Bind("PTI_ID") %>'></asp:Label>
                    </ItemTemplate>
             </asp:TemplateField>

              <asp:TemplateField AccessibleHeaderText="WO_SLNO" HeaderText="WO Slno" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblWOSlno" runat="server" Text='<%# Bind("PWO_SLNO") %>'></asp:Label>
                    </ItemTemplate>
             </asp:TemplateField>
             ...
             <asp:TemplateField AccessibleHeaderText="DF_DTC_CODE" HeaderText="DTC Code" SortExpression="DF_DTC_CODE">
                     <ItemTemplate>
                        <asp:Label ID="lblDtcCode" runat="server" Text='<%# Bind("PEST_DTC_CODE") %>'></asp:Label>
                    </ItemTemplate>
                     <FooterTemplate>
                ...
                <asp:TemplateField AccessibleHeaderText="TC_CODE" HeaderText="DTR Code">
                    <ItemTemplate>
                     ...
                     <FooterTemplate>
                       ...
                       <asp:TextBox ID="txtDtrCode" runat="server" placeholder="Enter DTr Code" Width="150px" MaxLength="10"></asp:TextBox>
                    </asp:Panel>
                    </FooterTemplate>
                </asp:TemplateField>
                 ...
                 <asp:TemplateField AccessibleHeaderText="WO_NO" HeaderText="Work Order No." SortExpression="WO_NO">
                    <ItemTemplate>
                        <asp:Label ID="lblWorkOrderNo" runat="server" Text='<%# Bind("PWO_NO_DECOM") %>'></asp:Label>
                    </ItemTemplate>
                     <FooterTemplate>
           ...
           <asp:GridView ID="grdNewDTCIndent" AutoGenerateColumns="false" PageSize="10" AllowPaging="true"                                  
                            ...
                            onrowdatabound="grdNewDTCIndent_RowDataBound" >
                                ...
                                <Columns>
                                 ...
                                 <asp:TemplateField AccessibleHeaderText="TI_ID" HeaderText="Indent Id" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblIndentId1" runat="server" Text='<%# Bind("PTI_ID") %>'></asp:Label>
                                    </ItemTemplate>
                               </asp:TemplateField>
                                 ...
                                 <asp:TemplateField AccessibleHeaderText="WO_SLNO" HeaderText="WO Slno" Visible="false">                           
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="WO_NO" HeaderText="WO No" >          
                                        <ItemTemplate>                                       
                                            <asp:Label ID="lblWoNo" runat="server" Text='<%# Bind("PWO_NO_DECOM") %>' style="word-break: break-all;" width="150px"></asp:Label>
                                        </ItemTemplate>
                                         <FooterTemplate>
                                           <asp:Panel ID="panel6" runat="server" DefaultButton="imgBtnSearch" >
                                          <asp:TextBox ID="TextBox1" runat="server" placeholder="Enter Wo No" Width="150px" MaxLength="17" ></asp:TextBox>
                                        </asp:Panel>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                     ...
                                     <asp:TemplateField AccessibleHeaderText="WO_DATE" HeaderText="WO Date" >          
                                        <ItemTemplate>                                       
                                            <asp:Label ID="lblWoDate" runat="server" Text='<%# Bind("PWO_DATE_DECOM") %>' style="word-break: break-all;" width="80px"></asp:Label>
                                        </ItemTemplate>
                                         <FooterTemplate>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="TI_INDENT_NO" HeaderText="Indent No" >          
                                     ...
                                     <asp:TemplateField AccessibleHeaderText="TI_INDENT_NO" HeaderText="Indent Date" >          
                                        <ItemTemplate>                                       
                                            <asp:Label ID="lblIndentDate" runat="server" Text='<%# Bind("PTI_INDENT_DATE") %>' style="word-break: break-all;" width="80px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

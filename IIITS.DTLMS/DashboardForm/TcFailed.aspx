                                ...
                                <HeaderStyle CssClass="both" />
                                   <%-- <HeaderStyle HorizontalAlign="center" CssClass="Warning" />--%>
                                    <Columns>
                                        <asp:TemplateField AccessibleHeaderText="TC_CODE" HeaderText="DTr Code" Visible="true" SortExpression="TC_CODE">
                                            ...
                                            <FooterTemplate>
                                                <asp:Panel ID="panel1" runat="server" DefaultButton="imgBtnSearch">
                                                    <asp:TextBox ID="txttCode" runat="server" placeholder="Enter DTr Code " Width="150px" onkeypress="return onlyAlphabetsnum(event,this);"
                                                   autocomplete="off"  onpaste="return false"   MaxLength="8"></asp:TextBox>
                                                </asp:Panel>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField AccessibleHeaderText="TC_CAPACITY" HeaderText="TC Capacity" Visible="true" SortExpression="TC_CAPACITY">
                                            <ItemTemplate>
                                            ...
                                            <FooterTemplate>
                                                <asp:Panel ID="panel2" runat="server" DefaultButton="imgBtnSearch">
                                                    <asp:TextBox ID="txttcCapacity" runat="server" placeholder="Enter TC CAPACITY " Width="150px"  onkeypress="javascript:return OnlyNumber(event);"
                                                      onpaste="return false" autocomplete="off" MaxLength="6"></asp:TextBox>
                                                </asp:Panel>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField AccessibleHeaderText="TC_SLNO" HeaderText="TC SlNo" Visible="true" SortExpression="TC_SLNO">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="TC_MANF_DATE" HeaderText="TC Manufacture Date" Visible="true">
                                            <ItemTemplate>
                                   ...
                                   <%-- <HeaderStyle HorizontalAlign="center" CssClass="Warning" />--%>
                                    <Columns>
                                        <asp:TemplateField AccessibleHeaderText="TC_CODE" HeaderText="DTr Code" Visible="true" SortExpression="TC_CODE">
                                            ...
                                            <FooterTemplate>
                                                <asp:Panel ID="panel1" runat="server" DefaultButton="imgBtnSearch">
                                                    <asp:TextBox ID="txttCode" runat="server" placeholder="Enter DTr Code " autocomplete="off" Width="150px" onkeypress="return onlyAlphabetsnum(event,this);"
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="TC_CAPACITY" HeaderText="TC Capacity" Visible="true" SortExpression="TC_CAPACITY">
                                            ...
                                            <FooterTemplate>
                                                <asp:Panel ID="panel2" runat="server" DefaultButton="imgBtnSearch">
                                                    <asp:TextBox ID="txttcCapacity" runat="server" placeholder="Enter TC CAPACITY"  onkeypress="javascript:return OnlyNumber(event);" Width="150px"
                                                      onpaste="return false" autocomplete="off" MaxLength="7"></asp:TextBox>
                                                </asp:Panel>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField AccessibleHeaderText="TC_SLNO" HeaderText="TC SlNo" Visible="true" SortExpression="TC_SLNO">
                                   ...
                                   <%-- <HeaderStyle HorizontalAlign="center" CssClass="Warning" />--%>
                                    <Columns>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="TC_CAPACITY" HeaderText="TC Capacity" Visible="true" SortExpression="TC_CAPACITY">
                                            <ItemTemplate>
                                                <asp:Label ID="lbltcCapacity" runat="server" Text='<%# Bind("TC_CAPACITY") %>' Style="word-break: break-all;"
                                                  onkeypress="javascript:return OnlyNumber(event);"   Width="100px"></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:Panel ID="panel2" runat="server" DefaultButton="imgBtnSearch">
                                                    <asp:TextBox ID="txttcCapacity" runat="server" placeholder="Enter TC CAPACITY " Width="150px"  onkeypress="javascript:return OnlyNumber(event);"
                                                       autocomplete="off" onpaste="return false" MaxLength="6"></asp:TextBox>
                                                </asp:Panel>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField AccessibleHeaderText="TC_SLNO" HeaderText="TC SlNo" Visible="true" SortExpression="TC_SLNO">
                                   ...
                                   <%-- <HeaderStyle HorizontalAlign="center" CssClass="Warning" />--%>
                                    <Columns>
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="TC_CAPACITY" HeaderText="TC Capacity" Visible="true" SortExpression="TC_CAPACITY">
                                            ...
                                            <FooterTemplate>
                                                <asp:Panel ID="panel2" runat="server" DefaultButton="imgBtnSearch">
                                                    <asp:TextBox ID="txttcCapacity" runat="server" placeholder="Enter TC CAPACITY " Width="150px" autocomplete="off" onpaste="return false"
                                                        onkeypress="javascript:return OnlyNumber(event);"  MaxLength="6"></asp:TextBox>
                                                </asp:Panel>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField AccessibleHeaderText="TC_SLNO" HeaderText="TC SlNo" Visible="true" SortExpression="TC_SLNO">
                                    ...
                                    <Columns>
                                        <asp:TemplateField AccessibleHeaderText="TC_CODE" HeaderText="DTr Code" Visible="true" SortExpression="TC_CODE">
                                            ...
                                            <FooterTemplate>
                                                <asp:Panel ID="panel1" runat="server" DefaultButton="imgBtnSearch">
                                                    <asp:TextBox ID="txttCode" runat="server" placeholder="Enter DTr Code " Width="150px" onkeypress="return onlyAlphabetsnum(event,this);"
                                                      onpaste="return false" autocomplete="off" MaxLength="8"></asp:TextBox>
                                                </asp:Panel>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField AccessibleHeaderText="TC_CAPACITY" HeaderText="TC Capacity" Visible="true" SortExpression="TC_CAPACITY">

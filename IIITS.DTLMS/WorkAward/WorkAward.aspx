        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                ...
                <div style="float: right; margin-top: 20px; margin-right: 12px">
                    <asp:Button ID="cmdClose" runat="server" Text="Close" CssClass="btn btn-danger"  OnClientClick="javascript:window.location.href='WorkAwardView.aspx'; return false;"/>
                </div>
            </div>
                            ...
                            <div class="widget-body form">
                                <div class="form-horizontal">
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="form-center" align="center" style="display:none">

                    ...
                    <div class="widget blue" >
                        ...
                        <div class="widget-body">
                                ...
                                <div style="float: right">
                                    <div class="span6">
                                        <asp:Button ID="cmdNewCircle" class="btn btn-success" Text="New Circle" runat="server"
                                            ...
                                            <asp:TemplateField AccessibleHeaderText="CM_CIRCLE_CODE" HeaderText="Circle Code"
                                                ...
                                                <FooterTemplate>
                                                    <asp:Panel ID="panel1" runat="server" DefaultButton="imgBtnSearch">
                                                        <asp:TextBox ID="txtCircleCode" runat="server" placeholder="Enter Circle Code" Width="150px"

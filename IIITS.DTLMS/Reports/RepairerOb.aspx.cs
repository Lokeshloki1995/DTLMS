...
{
    public partial class RepairerOb : System.Web.UI.Page
    {
        string strFormCode = "FailedOb";
        ...
        protected void Export_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sParam = "id=RepairerOb&Officecode=" + objrep.sOfficeCode + "&Month=" + objrep.sFromDate + "";

<%@ Page Title="" Language="C#" MasterPageFile="~/DTLMS.Master" AutoEventWireup="true" CodeBehind="FailuresDailyReport.aspx.cs" Inherits="IIITS.DTLMS.Reports.FailuresDailyReport" %>
                ...
                <div class="span12">
                    ...
                    <div class="widget blue">
                        <div class="widget-title">
                            <h4>
                                <i class="icon-reorder"></i>Daily Report</h4>
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <asp:Button ID="cmdReport" runat="server" Text="Generate Report" CssClass="btn btn-primary"
                                            OnClick="Export_clickFailureDailyReport" OnClientClick="javascript:return ValidateMyForm()" />

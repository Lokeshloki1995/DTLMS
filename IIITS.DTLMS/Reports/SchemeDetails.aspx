<%@ Page Title="" Language="C#" MasterPageFile="~/DTLMS.Master" AutoEventWireup="true" CodeBehind="SchemeDetails.aspx.cs" Inherits="IIITS.DTLMS.Reports.SchemeDetails" %>
            ...
            <div class="span12">
                ...
                <div class="widget blue">
                    <div class="widget-title">
                        <h4>
                            <i class="icon-reorder"></i>Schemes  Wise Failure Details </h4>
                          <a href="#" data-toggle="modal" data-target="#myModal" title="Click For Help" > <i class="fa fa-exclamation-circle" style="font-size: 36px"></i></a>
      ...
      <div class="row-fluid">
            <div class="span12">
                ...
                <div class="widget blue">
                    <div class="widget-title">
                        <h4>
                            <i class="icon-reorder"></i>Schemes  Wise capacity Details</h4>
                           <a href="#" data-toggle="modal" data-target="#myModal1" title="Click For Help" > <i class="fa fa-exclamation-circle" style="font-size: 36px"></i></a>
                                ...
                                <div class="span12">
                                    <div class="text-center" align="center">
                                        ...
                                        <asp:Button ID="Button1" runat="server" Text="Generate Report" CssClass="btn btn-primary"
                                            TabIndex="12" OnClick="Export_Click1"   OnClientClick="javascript:return Validate1()"/><br />
                                        <br />
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                      ...
                      <p style="color: Black">
                        <i class="fa fa-info-circle"></i>* This Report is Used to View the List of Transformers Scheme Wise Based on the Financial Year.
</p>
                    <p style="color: Black">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                      ...
                      <p style="color: Black">
                        <i class="fa fa-info-circle"></i>*This Report is used to View the List of Transformers Scheme and Capacity Wise.
</p>
                    <p style="color: Black">

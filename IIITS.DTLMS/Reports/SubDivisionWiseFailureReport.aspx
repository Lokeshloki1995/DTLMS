<%@ Page Title="" Language="C#" MasterPageFile="~/DTLMS.Master" AutoEventWireup="true" CodeBehind="SubDivisionWiseFailureReport.aspx.cs" Inherits="IIITS.DTLMS.Reports.SubDivisionWiseFailureReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/jscript">
        function Validate() {
            ...
            if (document.getElementById('<%= ddlMonth.ClientID %>').value.trim() == "--Select--" || document.getElementById('<%= ddlMonth.ClientID %>').value.trim() == null) {
                ...
                <div class="span12">
                    ...
                    <div class="widget blue">
                        <div class="widget-title">
                            <h4>
                                <i class="icon-reorder"></i>Subdivision Wise Failure Details</h4>
                                ...
                                <div class="form-horizontal">
                                    <div class="row-fluid">
                                        ...
                                        <div class="span5">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                        <asp:DropDownList ID="cmbDiv" runat="server" AutoPostBack="false" TabIndex="1"
                                                            >
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="span5">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                        <asp:DropDownList ID="ddlMonth" runat="server" AutoPostBack="false" TabIndex="1">
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <asp:Button ID="cmdReport" runat="server" Text="Generate Report" CssClass="btn btn-primary"
                                            OnClick="Generate_clickSubdivisionWiseFailureReport" OnClientClick="javascript:return ValidateMyForm()" />
                                      
                                        <asp:Button ID="Button3" runat="server" Text="Reset" CssClass="btn btn-danger"
                                            OnClick="BtnReset_Click" />

                                        <asp:Button ID="cmdExportReport" runat="server" Text="Export Report" CssClass="btn btn-info"
                                            OnClick="Export_clickSubdivisionWiseFailureReport" OnClientClick="javascript:return ValidateMyForm()" />
                                    </div>

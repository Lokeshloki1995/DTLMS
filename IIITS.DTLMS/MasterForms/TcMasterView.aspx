...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/jquery-OneEightThree.min.js" type="text/javascript"></script>
                                ...
                                <Columns>
                                  ...
                                  <asp:TemplateField AccessibleHeaderText="TC_CODE" HeaderText="DTR Code" SortExpression="TC_CODE">                                
                                        ...
                                        <asp:Panel ID="panel4" runat="server" DefaultButton="imgBtnSearch" >
                                           <asp:TextBox ID="txtTCCode" runat="server" placeholder="Enter DTr Code" MaxLength="8"></asp:TextBox>
                                           </asp:Panel>
                                        </FooterTemplate>
                                    </asp:TemplateField>

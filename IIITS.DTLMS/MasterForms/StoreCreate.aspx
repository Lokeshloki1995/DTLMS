                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="span5">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                        ...
                                                        <asp:TextBox ID="txtStoreName" runat="server" MaxLength="25" onkeypress="return onlyAlphabets(event,this);"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                             ...
                                             <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                        <asp:TextBox ID="txtAddress" runat="server" onkeypress="return Address(event,this);" Style="resize: none" TextMode="MultiLine"></asp:TextBox>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                        <asp:TextBox ID="txtStoreDescription" runat="server" onkeyup="return ValidateTextlimit(this,250);" Style="resize: none" TextMode="MultiLine"></asp:TextBox>
                                        ...
                                        <div class="span5">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append">
                                                        <asp:TextBox ID="txtInchargeName" runat="server" onkeypress="javascript:return AllowSpecialchar(event);"

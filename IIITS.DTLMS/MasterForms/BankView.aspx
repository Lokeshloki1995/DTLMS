<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/DTLMS.Master" CodeBehind="BankView.aspx.cs" Inherits="IIITS.DTLMS.MasterForms.BankView" %>
                ...
                <div class="span12">
                    ...
                    <div class="widget blue" >
                        <div class="widget-title" >
                            <h4><i class="icon-reorder"></i> Bank View</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                                ...
                                <div class="span6">
                                   <asp:Button ID="cmdNew" runat="server" Text="New Bank" 
                            ...
                            <asp:GridView ID="grdBank" 
                                ...
                                runat="server" onpageindexchanging="grdBank_PageIndexChanging" 
                                    ShowFooter="true" onrowcommand="grdBank_RowCommand" onrowdatabound="grdBank_RowDataBound" 
                                 OnSorting="grdBank_Sorting" AllowSorting="true">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField  HeaderText="ID" Visible="false">                                
                                        <ItemTemplate>                                       
                                            <asp:Label ID="lblBankId" runat="server" Text='<%# Bind("BM_ID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

<%--                                  <asp:TemplateField AccessibleHeaderText="SM_NAME" HeaderText="Store Name" SortExpression="BM_NAME">
                                       
                                        <ItemTemplate>
                                            <asp:Label ID="lblName" runat="server" Text='<%# Bind("BM_NAME") %>' style="word-break: break-all;" width="120"></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                        <asp:Panel ID="panel1" runat="server" DefaultButton="imgBtnSearch" >
                                          <asp:TextBox ID="txtBankName" runat="server" placeholder="Enter Store Name" ></asp:TextBox>
                                        </asp:Panel>
                                        </FooterTemplate>
                                    </asp:TemplateField>--%>
                                       <asp:TemplateField AccessibleHeaderText="SM_Mobile" HeaderText="Bank Name" SortExpression="BM_NAME">
                                       
                                        <ItemTemplate>
                                            <asp:Label ID="lblbank" runat="server" Text='<%# Bind("BM_NAME") %>' style="word-break: break-all;" width="100px"></asp:Label>
                                        </ItemTemplate>
                                          <FooterTemplate>
                                    ...
                                    <asp:TemplateField AccessibleHeaderText="BM_Location" HeaderText="Division Location" SortExpression="BM_SUBDIV_CODE">                           
                                        <ItemTemplate>
                                            <asp:Label ID="lblLocation" runat="server" Text='<%# Bind("BM_SUBDIV_CODE") %>' style="word-break: break-all;" width="200px"></asp:Label>
                                        </ItemTemplate>
                                         <FooterTemplate>
                                     ...
                                     <asp:TemplateField AccessibleHeaderText="SM_InchargeName" HeaderText="Incharge Name" SortExpression="BM_BANK_INCHARGE">
                                       
                                        <ItemTemplate>
                                            <asp:Label ID="lblInchargeName" runat="server" Text='<%# Bind("BM_BANK_INCHARGE") %>' style="word-break: break-all;" width="150px"></asp:Label>
                                        </ItemTemplate>
                                         <FooterTemplate>
                                     ...
                                     <asp:TemplateField AccessibleHeaderText="SM_Email" HeaderText="Mobile Number">
                                       
                                        <ItemTemplate>
                                            <asp:Label ID="lblMobile" runat="server" Text='<%# Bind("BM_MOBILENO") %>' style="word-break: break-all;" width="150px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField AccessibleHeaderText="SM_Email" HeaderText="Email Id">
                                       
                                        <ItemTemplate>
                                            <asp:Label ID="lblMailId" runat="server" Text='<%# Bind("BM_EMAILID") %>' style="word-break: break-all;" width="150px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                 ...
                                 <asp:TemplateField HeaderText="Status" Visible="false"> 
                                     <ItemTemplate>
                                        <asp:Label ID="lblStatus" runat="server" Visible="false" Text='<%# Eval("BM_STATUS") %>' ></asp:Label>
                                         <center>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="color: Black">
                        ...
                        Bank and New Bank Can Be Added
                    </p>
                    <p style="color: Black">
                        <i class="fa fa-info-circle"></i>Existing Bank Details Can Be Edited By Clicking
                        Edit Button
                    </p>
                    <p style="color: Black">
                        <i class="fa fa-info-circle"></i>New Bank Can Be Added By Clicking New Bank
                        Button
                    </p>
                </div>

                ...
                <div class="col-md-4">
                    <asp:GridView ID="grdOldDTC" DataKeyNames="DT_ID" runat="server" AutoGenerateColumns="false">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField AccessibleHeaderText="DT_CODE" HeaderText="DTC Code" Visible="true" ItemStyle-Width="100px">
                    ...
                    <asp:GridView ID="gridview2" runat="server" AutoGenerateColumns="false" OnRowCommand="grdDtc_RowCommand">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField AccessibleHeaderText="DT_CODE" HeaderText="Old DTC Code" Visible="true" ItemStyle-Width="100px">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblDTCCode" Width="100px" Font-Bold="true" Font-Size="Larger" runat="server" Text='<%# Bind("DT_CODE") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField AccessibleHeaderText="Serial Number" HeaderText="Serial Number" Visible="true" ItemStyle-Width="100px">
                                ...
                                <ItemTemplate>
                                    <asp:TextBox ID="lblDTCseraial" runat="server" Text='<%# Bind("DT_SERIAL_NUMBER") %>' ToolTip="Please Enter the Last Two Digit" CssClass="ChkBoxClass"
                                        Width="30px" MaxLength="3" onblur="getValue(this)" OnKeyPress="javascript: return OnlyAlphabetNumbers(event);"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
